...
PM_TO_BLIB = lib/Class/DBI/Plugin/RetrieveAll.pm \
...
DISTVNAME = Class-DBI-Plugin-RetrieveAll-1.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3pm --perm_rw=$(PERM_RW)\
	  lib/Class/DBI/Plugin/RetrieveAll.pm $(INST_MAN3DIR)/Class::DBI::Plugin::RetrieveAll.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/Class/DBI/Plugin/RetrieveAll.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Class-DBI-Plugin-RetrieveAll' >> META.yml
	$(NOECHO) $(ECHO) 'version:      1.01' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: lib/Class/DBI/Plugin/RetrieveAll.pm' >> META.yml
	$(NOECHO) $(ECHO) 'installdirs:  site' >> META.yml
	$(NOECHO) $(ECHO) 'requires:' >> META.yml
	$(NOECHO) $(ECHO) '    Class::DBI:                    0.95' >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Class-DBI" VERSION="0,95,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/Class/DBI/Plugin/RetrieveAll.pm blib/lib/Class/DBI/Plugin/RetrieveAll.pm 
	$(NOECHO) $(TOUCH) $@
