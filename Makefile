# This Makefile is for the Class::DBI::Plugin::RetrieveAll extension to perl.
#
...
#     NAME => q[Class::DBI::Plugin::RetrieveAll]
#     PREREQ_PM => { Class::DBI=>q[0.95] }
#     VERSION_FROM => q[lib/Class/DBI/Plugin/RetrieveAll.pm]
...
DISTNAME = Class-DBI-Plugin-RetrieveAll
NAME_SYM = Class_DBI_Plugin_RetrieveAll
VERSION = 1
VERSION_SYM = 1
XS_VERSION = 1
...
FULLEXT = Class/DBI/Plugin/RetrieveAll
BASEEXT = RetrieveAll
PARENT_NAME = Class::DBI::Plugin
DLBASE = $(BASEEXT)
...
H_FILES = 
MAN1PODS = 
MAN3PODS = lib/Class/DBI/Plugin/RetrieveAll.pm
...
# Where to put things:
INST_LIBDIR      = $(INST_LIB)/Class/DBI/Plugin
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Class/DBI/Plugin
...
TO_INST_PM = lib/Class/DBI/Plugin/RetrieveAll.pm \
	lib/Class/DBI/Plugin/RetrieveAll.pm.ERR \
	lib/Class/DBI/Plugin/RetrieveAll.pm.bak

PM_TO_BLIB = lib/Class/DBI/Plugin/RetrieveAll.pm.ERR \
	blib/lib/Class/DBI/Plugin/RetrieveAll.pm.ERR \
	lib/Class/DBI/Plugin/RetrieveAll.pm.bak \
	blib/lib/Class/DBI/Plugin/RetrieveAll.pm.bak \
	lib/Class/DBI/Plugin/RetrieveAll.pm \
	blib/lib/Class/DBI/Plugin/RetrieveAll.pm
...
manifypods : pure_all lib/Class/DBI/Plugin/RetrieveAll.pm
	@$(POD2MAN) \
	lib/Class/DBI/Plugin/RetrieveAll.pm \
	$(INST_MAN3DIR)/Class::DBI::Plugin::RetrieveAll.$(MAN3EXT)
...
realclean purge ::  clean
	...
	rm -rf $(DISTVNAME)
	rm -f  blib/lib/Class/DBI/Plugin/RetrieveAll.pm.ERR
	rm -f blib/lib/Class/DBI/Plugin/RetrieveAll.pm.bak
	rm -f blib/lib/Class/DBI/Plugin/RetrieveAll.pm
...
ppd:
	...
	@$(PERL) -e "print qq{\t<IMPLEMENTATION>\n\t\t<DEPENDENCY NAME=\"Class-DBI\" VERSION=\"0,95,0,0\" />\n}" >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{lib/Class/DBI/Plugin/RetrieveAll.pm.ERR blib/lib/Class/DBI/Plugin/RetrieveAll.pm.ERR lib/Class/DBI/Plugin/RetrieveAll.pm.bak blib/lib/Class/DBI/Plugin/RetrieveAll.pm.bak}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(PERLRUNINST) "-MExtUtils::Install" \
	-e "pm_to_blib({qw{lib/Class/DBI/Plugin/RetrieveAll.pm blib/lib/Class/DBI/Plugin/RetrieveAll.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
